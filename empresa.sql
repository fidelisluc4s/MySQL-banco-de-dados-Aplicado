...
/* selecione os funcionarios em que o cpf do supervisor possui o valor nulo*/

select * 
from funcionario 
where cpf_supervisor is null;

/* selecione os funcionarios que nao sao do sexo feminino */
select *
from funcionario 
where sexo !='F';

/* selecione os funcionarios em que o cpf do supervisor não é nulo ou ganham mais que 35000 */

select *
from funcionario
where cpf_supervisor  is not null or salario > 35000;

/* selecione os funcionarios homens em que a data de nascimento é maior que 01/01/1962 */

select *
from funcionario
where sexo = 'M' and datanasc > '1962-01-01';

/*selecione os funcionarios que tem o sobrenome 'Silva' ou que o nome seja 'Jorge' */

select *
from funcionario
where pnome = 'Jorge' or unome = 'Silva'; 
