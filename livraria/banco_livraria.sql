...
CREATE TABLE `autor` (
  ...
  `anonascimento` year DEFAULT NULL,
  `anofalecimento` year DEFAULT NULL,
...
INSERT INTO `autor` VALUES (1023,'Sandra Puga',1954,NULL),(1234,'Shamkant Navathe',1948,NULL),(2345,'Carlos Heuser',1951,NULL),(3456,'C.J.Date',1948,NULL),(4567,'Henry F.Silberschatz',1950,NULL),(5678,'Michael Morrison',1960,NULL),(6789,'Eric Freeman',1970,NULL),(7890,'Elisabeth Freeman',1956,NULL),(8901,'Mark L. Gillenson',1954,NULL),(9012,'Paul Barry',1957,NULL);
...
CREATE TABLE `estoque` (
  ...
  `numlivro` decimal(4,0) DEFAULT NULL,
  `quantidade` decimal(4,0) DEFAULT NULL,
  PRIMARY KEY (`idestoque`),
  KEY `fk_estoque_livro` (`numlivro`),
  CONSTRAINT `fk_estoque_livro` FOREIGN KEY (`numlivro`) REFERENCES `livro` (`numlivro`)
...
INSERT INTO `estoque` VALUES (1,1010,749),(2,1111,380),(3,2222,409),(4,3333,650),(5,4444,120),(6,5555,948),(7,6666,991),(8,7777,1000),(9,8888,720),(10,9999,553);
...
-- Dump completed on 2022-04-11 10:24:51
